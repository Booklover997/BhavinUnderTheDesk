...
export default function Home() {
  return <>
  <h1>I'm a Cybersecurity student who competes in CTF's with 0xf1sh and a gamer/reader. This website is a compilation of my accomplishments and hobbies as well as funny people from my life. If anyone is mentioned on this website it is purely for fun and not in a serious manner, and is a sign that I respect them.</h1>
